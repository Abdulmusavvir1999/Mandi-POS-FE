...
export const SIDEBAR_LAYOUT_CSS = `
  ...
  /* ════════════════════════════════════════════════════════════════════ */
  /* TEMPLATE 1 — DEFAULT · the shipped rail, polished                    */
  /* ════════════════════════════════════════════════════════════════════ */
  .sidebar-container.tpl-default {
    box-shadow: 2px 0 12px rgba(0, 0, 0, var(--sb-shadow-a));
  }

  .tpl-default .menu-item.is-active .active-indicator {
    animation: sbBarGrow 260ms var(--sb-spring) both;
    transform-origin: center;
  }

  .tpl-default .menu-item:hover .item-icon-wrapper {
    transform: scale(1.16) rotate(-3deg);
  }

  .tpl-default .menu-item.is-active {
    box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 22%, transparent);
  }
  ...
  /* ════════════════════════════════════════════════════════════════════ */
  /* TEMPLATE 4 — COMPACT · high-density module rail                      */
  /* ════════════════════════════════════════════════════════════════════ */
  .sidebar-container.tpl-compact {
    box-shadow: 2px 0 10px rgba(0, 0, 0, var(--sb-shadow-a));
  }

  .tpl-compact .brand-header {
    height: 54px;
    min-height: 54px;
    padding: 0 10px;
  }

  .tpl-compact .brand-logo-container {
    width: 30px;
    height: 30px;
    border-radius: 7px;
  }

  .tpl-compact .brand-title {
    font-size: 13px;
  }
  .tpl-compact .brand-subtitle {
    display: none;
  }

  .tpl-compact .section-label {
    font-size: 9px;
    padding: 2px 8px;
    letter-spacing: 0.1em;
  }

  .tpl-compact .menu-item {
    padding: 0 8px;
    gap: 8px;
    font-weight: 500;
  }

  .tpl-compact .menu-item:hover .item-icon-wrapper {
    transform: scale(1.18);
    color: var(--sidebar-active-accent, #C084FC);
  }

  .tpl-compact .menu-item.is-active {
    background: color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 18%, var(--sidebar-surface, #3B0764));
  }

  .tpl-compact .active-indicator {
    width: 2.5px;
  }

  .tpl-compact .item-badge {
    font-size: 9px;
    padding: 0 4px;
  }

  .tpl-compact .sidebar-footer {
    min-height: 48px;
    padding: 6px 8px;
  }
  .tpl-compact .user-avatar {
    width: 28px;
    height: 28px;
    font-size: 11px;
  }
  ...
  /* ════════════════════════════════════════════════════════════════════ */
  /* TEMPLATE 7 — ELEGANT · premium typography + gradient sweep           */
  /* ════════════════════════════════════════════════════════════════════ */
  .sidebar-container.tpl-elegant {
    box-shadow: 2px 0 20px rgba(0, 0, 0, var(--sb-shadow-a));
    background-image: linear-gradient(
      180deg,
      color-mix(in srgb, var(--sidebar-bg, #2E1065) 100%, #FFFFFF 0%),
      color-mix(in srgb, var(--sidebar-bg, #2E1065) 88%, #000000 12%)
    );
  }

  .tpl-elegant .section-label {
    position: relative;
    font-size: 9.5px;
  ...
  /* Hairline rule trailing each group heading */
  .tpl-elegant .section-label::after {
    content: '';
    flex: 1;
    height: 1px;
    margin-left: 4px;
    background: linear-gradient(
      90deg,
      color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 40%, transparent),
      transparent
    );
  }

  .tpl-elegant .menu-item {
    overflow: hidden;
    border: 1px solid transparent;
  }

  /* Gradient wash sweeping left → right on hover */
  .tpl-elegant .menu-item::before {
    content: '';
    position: absolute;
    inset: 0;
    z-index: -1;
    ...
    background: linear-gradient(
      90deg,
      color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 26%, transparent),
      transparent 70%
    );
  ...
  .tpl-elegant .menu-item:hover::before {
    transform: translateX(0);
  }

  .tpl-elegant .menu-item:hover {
    background-color: transparent;
    border-color: color-mix(in srgb, var(--sidebar-border, #581C87) 80%, transparent);
  }

  .tpl-elegant .menu-item:hover .item-label {
    letter-spacing: 0.035em;
  }

  .tpl-elegant .menu-item.is-active {
    background: linear-gradient(
      90deg,
      color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 20%, transparent),
      transparent 85%
    );
    border-color: color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 30%, transparent);
    letter-spacing: 0.03em;
  }

  .tpl-elegant .menu-item.is-active::before {
    transform: translateX(0);
    opacity: 0.5;
  }

  .tpl-elegant .active-indicator {
    width: 2px;
    left: 0;
    border-radius: 2px;
  }

  .tpl-elegant .user-profile-card {
    border: 1px solid color-mix(in srgb, var(--sidebar-border, #581C87) 60%, transparent);
    padding: 6px;
  }

  /* ════════════════════════════════════════════════════════════════════ */
  /* TEMPLATE 8 — DASHBOARD PRO · full ERP command rail                   */
  /* ════════════════════════════════════════════════════════════════════ */
  .sidebar-container.tpl-dashboardpro {
    box-shadow: 4px 0 24px -6px rgba(0, 0, 0, var(--sb-shadow-a));
  }

  .tpl-dashboardpro .brand-header {
    height: 68px;
    min-height: 68px;
    box-shadow: 0 2px 10px -4px rgba(0, 0, 0, 0.5);
  }

  .tpl-dashboardpro .section-label {
    font-size: 10px;
    font-weight: 800;
    letter-spacing: 0.1em;
    color: var(--sidebar-text-muted, #D8B4FE);
  ...
  .tpl-dashboardpro .menu-item {
    font-weight: 500;
  }

  .tpl-dashboardpro .menu-item:hover {
    background: color-mix(in srgb, var(--sidebar-surface, #3B0764) 95%, #FFFFFF 5%);
    box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 22%, transparent);
  }

  .tpl-dashboardpro .menu-item.is-active {
    background: var(--sidebar-active-accent, #C084FC);
    color: var(--sidebar-bg, #2E1065);
    font-weight: 700;
    box-shadow: 0 6px 16px -6px color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 70%, transparent);
  }

  .tpl-dashboardpro .menu-item.is-active .item-icon-wrapper {
    color: var(--sidebar-bg, #2E1065);
  }

  .tpl-dashboardpro .menu-item.is-active .item-badge {
    background: color-mix(in srgb, var(--sidebar-bg, #2E1065) 22%, transparent);
    border-color: transparent;
    color: var(--sidebar-bg, #2E1065);
  }

  .tpl-dashboardpro .menu-item.is-active .active-indicator {
    display: none;
  }

  .tpl-dashboardpro .pos-special-item.is-active {
    background: #F472B6;
    color: #4A044E;
  }
  .tpl-dashboardpro .pos-special-item.is-active .item-icon-wrapper {
    color: #4A044E;
  }

  .tpl-dashboardpro .sidebar-footer {
    background: color-mix(in srgb, var(--sidebar-surface, #3B0764) 45%, transparent);
  }
  ...
  /* ════════════════════════════════════════════════════════════════════ */
  /* TEMPLATE 10 — SMART NAVIGATION · adaptive productivity rail          */
  /* ════════════════════════════════════════════════════════════════════ */
  .sidebar-container.tpl-smart {
    box-shadow: 3px 0 18px -4px rgba(0, 0, 0, var(--sb-shadow-a));
  }

  .tpl-smart .menu-item:hover {
    background: color-mix(in srgb, var(--sidebar-surface, #3B0764) 92%, #FFFFFF 8%);
  }

  .tpl-smart .menu-item:hover .item-icon-wrapper {
    animation: sbBounceIcon 420ms var(--sb-spring) both;
  }

  .tpl-smart .menu-item.is-active {
    background: color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 16%, var(--sidebar-surface, #3B0764));
    box-shadow:
      0 4px 14px -6px rgba(0, 0, 0, 0.5),
      inset 0 0 0 1px color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 30%, transparent);
  }

  /* The indicator animates its height into place rather than fading */
  .tpl-smart .active-indicator {
    left: 4px;
    width: 3px;
    border-radius: 3px;
    transition: height 320ms var(--sb-spring), opacity 180ms ease;
  }
  .tpl-smart .menu-item.is-active .active-indicator {
    height: calc(100% - 16px);
  }

  .tpl-smart button.section-label:hover {
    background: color-mix(in srgb, var(--sidebar-surface, #3B0764) 85%, transparent);
  }

  .tpl-smart .item-label {
    animation: sbLabelIn 260ms var(--sb-ease) backwards;
  }

  /* ════════════════════════════════════════════════════════════════════ */
  /* TEMPLATE 11 — COLLAPSIBLE PRO · collapse-gesture choreography        */
  /* ════════════════════════════════════════════════════════════════════ */
  .sidebar-container.tpl-collapsiblepro {
    box-shadow: 4px 0 22px -8px rgba(0, 0, 0, var(--sb-shadow-a));
    transition:
      width var(--sb-anim) var(--sb-spring),
      min-width var(--sb-anim) var(--sb-spring),
      max-width var(--sb-anim) var(--sb-spring),
      box-shadow var(--sb-anim) ease;
  }

  .tpl-collapsiblepro .collapse-toggle-btn {
    background: color-mix(in srgb, var(--sidebar-surface, #3B0764) 80%, transparent);
    border-color: var(--sidebar-border, #581C87);
  }

  .tpl-collapsiblepro .collapse-toggle-btn .toggle-icon {
    transition: transform var(--sb-anim) var(--sb-spring);
  }
  .tpl-collapsiblepro .collapse-toggle-btn:hover .toggle-icon {
    transform: rotate(180deg);
  }

  .tpl-collapsiblepro .item-label,
  .tpl-collapsiblepro .brand-meta,
  .tpl-collapsiblepro .user-details {
    animation: sbLabelIn var(--sb-anim) var(--sb-ease) backwards;
  }

  .tpl-collapsiblepro .menu-item:hover {
    background: color-mix(in srgb, var(--sidebar-surface, #3B0764) 94%, #FFFFFF 6%);
    box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 25%, transparent);
  }

  .tpl-collapsiblepro .menu-item.is-active {
    background: color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 18%, var(--sidebar-surface, #3B0764));
    box-shadow: inset 0 0 0 1.5px color-mix(in srgb, var(--sidebar-active-accent, #C084FC) 55%, transparent);
  }

  /* Collapsed rows become centred glowing tiles */
  .tpl-collapsiblepro.is-collapsed .menu-item {
    width: 44px;
    margin: 0 auto;
    border-radius: 13px;
  }
  .tpl-collapsiblepro.is-collapsed .menu-item.is-active {
    animation: sbGlow 2.8s ease-in-out infinite;
  }
  .tpl-collapsiblepro.is-collapsed .active-indicator {
    display: none;
  }

  .tpl-collapsiblepro .active-indicator {
    left: 3px;
    border-radius: 3px;
  }
