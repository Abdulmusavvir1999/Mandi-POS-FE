...
export const PREVIEW_CATEGORIES: Category[] = [
  { id: 1, name: 'Mutton Mandi', description: 'Slow-cooked lamb', display_order: 1, status: 'ACTIVE' },
  { id: 2, name: 'Chicken Mandi', description: 'Spiced roast chicken', display_order: 2, status: 'ACTIVE' },
...
export const PREVIEW_PRODUCTS: Product[] = [
  dish(1, 1, 'Mutton Mandi Full', 450, 'Slow-cooked succulent tender lamb over fragrant basmati rice.', 24),
  dish(2, 2, 'Chicken Mandi Half', 260, 'Traditional spiced roast chicken with saffron rice and sauce.', 38),
  ...
  dish(5, 1, 'Mutton Mandi Half', 260, 'Half portion of the slow-cooked lamb over basmati rice.', 30),
